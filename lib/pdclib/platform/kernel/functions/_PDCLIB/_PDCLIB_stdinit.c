...
static FILE _PDCLIB_vout = { 
    .ops        = &_PDCLIB_fileops, 
    .buffer     = _PDCLIB_vout_buffer, 
    .bufsize    = BUFSIZ, 
    .bufidx     = 0, 
    .bufend     = 0, 
    .ungetidx   = 0, 
    .ungetbuf   = _PDCLIB_vout_ungetbuf, 
    .status     = _IOLBF | _PDCLIB_FWRITE | _PDCLIB_STATIC, 
    .filename   = NULL, 
    .next       = &_PDCLIB_sout 
};
